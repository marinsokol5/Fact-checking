...
if __name__ == '__main__':
    train_data = GoogleDatasetBert.from_pickle(GoogleDataset.TRAIN_DATA)
    validation_data = GoogleDatasetBert.from_pickle(GoogleDataset.VALIDATION_DATA)
    test_data = GoogleDatasetBert.from_pickle(GoogleDataset.TEST_DATA)

    visdom_vision = visdom.Visdom()

    bert_model = BertForSequenceClassification.from_pretrained("bert-base-uncased", num_labels=2)
    # bert_model = load_bert_model("bert_1")
